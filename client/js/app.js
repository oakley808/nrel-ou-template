 ...
 *  Set search, breadcrumbs, side navigation, top nav, and webmaster link.
 *  Label icons
 *  Init lightbox
 *
...
$(document).ready(function(){
     ...
     * (this is usually the case for sub pages that just aren't listed in the nav)
     *
